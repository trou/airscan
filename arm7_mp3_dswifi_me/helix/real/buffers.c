...
u8 mp3DecMem[sizeof(MP3DecInfo)];	// <PALIB-CHANGE>
...
MP3DecInfo *AllocateBuffers(void)
{
	...
	mp3DecInfo = (MP3DecInfo *)(mp3DecMem);	// <PALIB-CHANGE>
	if (!mp3DecInfo)
		return 0;
	ClearBuffer(mp3DecInfo, sizeof(MP3DecInfo));
	
	// <PALIB-CHANGE>
	fh =  (FrameHeader *)     (IPC_Sound->mp3.helixbuffer);
	si =  (SideInfo *)        (IPC_Sound->mp3.helixbuffer + sizeof(FrameHeader));
	sfi = (ScaleFactorInfo *) (IPC_Sound->mp3.helixbuffer + sizeof(FrameHeader) + sizeof(SideInfo));
	//hi =  (HuffmanInfo *)     (huffmanMem);
	hi =  (HuffmanInfo *)     (IPC_Sound->mp3.helixbuffer + sizeof(FrameHeader) + sizeof(SideInfo) + sizeof(ScaleFactorInfo));
	di =  (DequantInfo *)     (dequantMem);
	//di =  (DequantInfo *)     (IPC_Sound->mp3.helixbuffer + sizeof(FrameHeader) + sizeof(SideInfo) + sizeof(ScaleFactorInfo) + sizeof(HuffmanInfo));
	mi =  (IMDCTInfo *)       (IPC_Sound->mp3.helixbuffer + sizeof(FrameHeader) + sizeof(SideInfo) + sizeof(ScaleFactorInfo) + sizeof(HuffmanInfo) + sizeof(DequantInfo));
